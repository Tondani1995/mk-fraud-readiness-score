...
await test('current V1.2 migration source is certified by the exact disposable replay contract', async () => {
  ...
  includes(v12Replay, 'forward_migration_count=3', 'replay has three forward migrations');
  ...
  includes(v12Replay, 'PASS: %s/%s migrations replayed in deterministic filename order (%s reconstructed plus %s forward).', 'replay prints exact 124/124 evidence');

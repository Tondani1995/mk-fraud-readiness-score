...
await test('full migration postflight requires exactly 66 rows', async () => {
  includes(postflight, 'count(*) = 66', 'postflight total is 66');
  includes(postflight, "max(version) = '20260803190000'", 'postflight newest correction is exact');
});

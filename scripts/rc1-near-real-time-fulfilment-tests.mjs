...
await test('full migration postflight requires exactly 63 rows', async () => {
  includes(postflight, 'count(*) = 63', 'postflight total is 63');
  includes(postflight, "max(version) = '20260803160000'", 'postflight newest correction is exact');
});

...
await test('full migration postflight requires exactly 62 rows', async () => {
  includes(postflight, 'count(*) = 62', 'postflight total is 62');
  includes(postflight, "max(version) = '20260803090000'", 'postflight newest correction is exact');
});

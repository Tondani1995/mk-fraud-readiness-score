...
await test('full migration postflight requires exactly 53 rows', async () => {
  includes(postflight, 'count(*) = 53', 'postflight total is 53');
  includes(postflight, "max(version) = '20260801070000'", 'postflight newest correction is exact');
});

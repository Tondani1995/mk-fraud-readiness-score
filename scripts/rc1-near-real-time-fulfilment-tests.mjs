...
await test('full migration postflight requires exactly 65 rows', async () => {
  includes(postflight, 'count(*) = 65', 'postflight total is 65');
  includes(postflight, "max(version) = '20260803180000'", 'postflight newest correction is exact');
});

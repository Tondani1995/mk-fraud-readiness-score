...
await test('full migration postflight requires exactly 49 rows', async () => {
  includes(postflight, 'count(*) = 49', 'postflight total is 49');
  includes(postflight, "max(version) = '20260730130000'", 'postflight newest correction is exact');
});

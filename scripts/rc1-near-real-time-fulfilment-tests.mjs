...
await test('full migration postflight requires exactly 52 rows', async () => {
  includes(postflight, 'count(*) = 52', 'postflight total is 52');
  includes(postflight, "max(version) = '20260731170000'", 'postflight newest correction is exact');
});

...
// re-verification" and the closure-cycle entries) — reused here via a real import from the repo
// (not reimplemented by hand) so there is no risk of the probe's signature construction silently
// drifting from the real verifyResendWebhook()/createProviderWebhookDatabaseAttestation() logic.
//
...
import { createProviderWebhookDatabaseAttestation, webhookPayloadFingerprint } from '../src/lib/reports/email/resend-webhook.ts';

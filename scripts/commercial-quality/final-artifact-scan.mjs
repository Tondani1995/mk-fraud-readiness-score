...
await fs.writeFile(path.join(final, 'evidence-reconciliation-report.md'), `# Evidence reconciliation report\n\nPASS — the Comprehensive artefact is generated from the persisted deterministic analytical universe. The source manifest records ${comprehensiveSource.analyticalCounts.evidenceRequirements} evidence requirements, ${comprehensiveSource.analyticalCounts.questionTraces} question traces, ${comprehensiveSource.analyticalCounts.findings} material findings, ${comprehensiveSource.analyticalCounts.risks} risks and ${comprehensiveSource.analyticalCounts.roadmapActions} roadmap actions. Review notes remain bounded to the supplied record and do not change the deterministic score.`);

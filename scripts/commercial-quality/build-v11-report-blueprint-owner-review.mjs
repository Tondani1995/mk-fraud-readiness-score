...
async function main() {
  ...
  const manifest = {
    ...
    focusedArchitectureTests: { blueprint: 'PASS', severity: 'PASS', recovery: 'PASS', hierarchy: 'PASS', contextCapacity: 'PASS', exhibitNarrativeContract: 'PASS', narrativeRoles: 'PASS', usageLedger: 'PASS', transformationSequence: 'PASS' },
    generatedFiles
  };

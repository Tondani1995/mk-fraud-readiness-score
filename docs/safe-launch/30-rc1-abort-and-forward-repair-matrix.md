...
| Migration-ledger mismatch | Stop; do not mark rows manually | No default rollback | Reconcile ledger/version identity forward | Pre/post ledger outputs, CLI version | Tondani / Codex after approval | Exact nine-row cutover delta and 43-row ledger state restored |

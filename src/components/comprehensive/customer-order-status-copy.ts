...
export function getCustomerOrderStatusCopy(tier: CustomerOrderStatusTier): CustomerOrderStatusCopy {
  ...
  return {
    ...
    paymentReleaseDescription: 'MK confirms payment manually before an operator prepares the purchased report package.',
    nextStepDescription: 'After MK confirms payment, an MK operator prepares and quality-checks the Essential report PDF. MK then emails the final file manually to your nominated delivery email and marks the order delivered.',

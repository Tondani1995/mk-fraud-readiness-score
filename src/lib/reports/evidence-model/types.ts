...
export type CommercialQualityIssueCode =
  ...
  // Bounded Essential output contract (D6 layer 3): the generated PDF's supporting control-action
  // detail does not reconcile against the authoritative L1 universe.
  ...
  | 'QG_CLEAN_ASSURANCE_SEMANTIC_FAILURE'
  | 'QG_EXPOSURE_HEADING_MISMATCH'
  | 'QG_META_TEST_COPY'
  | 'QG_AI_GENERIC_REPETITION'
  | 'QG_AI_NOT_MATERIALLY_DIFFERENT'
  | 'QG_INTERNAL_METHOD_CODE_OVERUSE';

...
export async function collectHeadingMatchDiagnostics(
  ...
  // Every page is read so the extractor can distinguish the actual rendered heading from an
  ...
  for (const entry of entries) {
    ...
    // A tracked heading must be recoverable from a bounded run of heading-sized text items. This

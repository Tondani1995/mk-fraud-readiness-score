...
export const WHOLE_MANUSCRIPT_PROMPT_VERSION = 'mk-fraud-readiness-essential-whole-manuscript-blueprint-text-v2';
...
function generationPrompt(input: WholeManuscriptWriterInput): string {
  ...
  return [
    'Write the complete MK Fraud Readiness Essential advisory manuscript as Markdown.',
    '',
    ...
    'RELATIVE-STRENGTH BOUNDARY. A comparatively stronger self-assessed score, domain or response pattern does not by itself establish that a control, reporting channel, process or capability is functioning, established, active, workable, effective, operational, embedded or operating in practice, and it does not establish a usable, practical or constructive operating foundation. Unless the permitted deterministic facts explicitly establish that present operating state, describe it only as a reported relative strength, a comparatively stronger self-assessed area or a stronger reported position. Do not upgrade self-assessed strength into present-state capability language. In particular, do not describe a relative strength as an established foundation, some established foundations, a foundation already in place, a functioning foundation, or equivalent present-state foundation language unless a permitted deterministic fact explicitly establishes that operating state. Do not infer leadership attention, management commitment, organisational intent, mobilisation capacity, a functioning reporting culture, or a basis/foundation for corrective work from a higher self-assessed score. A relative strength should normally be stated only as a comparatively stronger reported or self-assessed position.',
...
function semanticReviewPrompt(input: SemanticReviewerInput): string {
  return [
    ...
    'ALLOW means every customer-specific factual proposition in the block is semantically grounded by its permitted facts and remains inside the assurance boundary. Inspect structure, actors/teams, mechanisms, workflow/routing, sites, populations, sampling, frequency, capacity, ownership, control state, causality, comparisons, knowledge concentration and assurance language, not only the warning signals. Distinguish descriptive current/past claims from prescriptive advisory content: a target-state recommendation, roadmap action or management instruction does not assert that the organisation already operates that way. Prescriptive control design may elaborate the deterministic requiredManagementTakeaway and Blueprint role using generic implementation mechanics, but it must not invent client-specific actors, systems, locations, populations, frequencies, costs or completed evidence states. A self-assessed relative strength or higher score is not evidence that a control or capability is functioning, established, active, workable, effective, operational, embedded or a usable/practical/constructive operating foundation. Unless a permitted fact explicitly establishes that present operating state, such wording must be REPAIR rather than ALLOW; this includes phrases such as established foundation, established foundations, foundation already in place, functioning foundation, workable foundation or equivalent present-state foundation claims. Do not infer leadership attention, management commitment, organisational intent, mobilisation capacity, functioning reporting culture or a corrective-work foundation from a higher score alone. Retain the management implication but rewrite it as a reported relative strength or comparatively stronger self-assessed position. REPAIR means the management implication is valid but the target prose overstates the evidence. REJECT means the proposition cannot be made true without changing deterministic meaning. HOLD means unresolved ambiguity.',

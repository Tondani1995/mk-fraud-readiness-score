...
const PATTERNS: Partial<Record<PrimarySemanticFamily, { embed: MaturationPattern; mature: MaturationPattern }>> = {
  ...
  PAYROLL_INTEGRITY: {
    embed: { managementOutcome: 'Payroll changes and unusual records are challenged before payment release.', priorityActivity: 'Embed joiner/mover/leaver reconciliation, independent master-file review and exception closure before each payroll run.', successMeasure: 'Every payroll run has a complete pre-payment review with all sensitive changes and unusual records dispositioned.', proofOfProgress: 'Retain payroll change reports, reconciliations, review sign-offs and exception closure evidence.' },
    mature: { managementOutcome: 'Payroll integrity is measured across change patterns, exceptions and recovery outcomes.', priorityActivity: 'Mature payroll controls through trend analytics, targeted testing and independent challenge of high-risk changes.', successMeasure: 'Payroll anomaly trends drive timely control, process or access improvements.', proofOfProgress: 'Retain trend reports, test results, investigations, challenge records and resulting control changes.' }
  },
  CASH_CUSTODY: {
    embed: { managementOutcome: 'Cash custody, counting and reconciliation operate through defined accountability.', priorityActivity: 'Embed cash-point ownership, attributable counts, sealed transfers, banking reconciliation and shortage escalation.', successMeasure: 'Every cash point reconciles on schedule and every difference has a recorded investigation or escalation.', proofOfProgress: 'Retain custody registers, count sheets, banking reconciliations and difference investigations.' },
    mature: { managementOutcome: 'Cash-control performance is analysed across locations, custodians and difference trends.', priorityActivity: 'Mature cash oversight through trend analysis, surprise counts and independent challenge of recurring differences.', successMeasure: 'Difference patterns inform control changes and recurring exceptions are reduced or escalated.', proofOfProgress: 'Retain trend packs, surprise-count results, challenge records and improvement actions.' }
  },
  STOCK_ASSET_CUSTODY: {
    embed: { managementOutcome: 'Stock and physical assets are assigned, moved, counted and reconciled through a defined custody cycle.', priorityActivity: 'Embed complete registers, authorised movement, periodic counts, reconciliation and independent write-off review.', successMeasure: 'Material assets and stock are counted on schedule with differences, disposals and write-offs dispositioned.', proofOfProgress: 'Retain registers, movement approvals, count results, reconciliations and write-off reviews.' },
    mature: { managementOutcome: 'Physical-asset integrity is measured across locations, movement patterns and shrinkage outcomes.', priorityActivity: 'Mature asset oversight through risk-based counts, movement analytics and independent review of recurring shrinkage.', successMeasure: 'Shrinkage and write-off trends drive timely custody, process or security improvements.', proofOfProgress: 'Retain trend reports, count analytics, investigations, challenge records and resulting control changes.' }
  }
};

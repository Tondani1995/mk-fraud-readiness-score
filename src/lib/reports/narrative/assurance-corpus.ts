...
export const ASSURANCE_MUST_ALLOW: AssuranceCorpusEntry[] = [
  ...
  { id: 'allow-control-objective-01', text: 'The intended measure is a complete custody trail; this is a management control objective, not a statement that evidence has been validated.', source: 'essential-false-positive-safety-net-tests + narrative-assurance-semantics (rivoniaAmbiguousDisclaimer)', expectNoCandidate: true },

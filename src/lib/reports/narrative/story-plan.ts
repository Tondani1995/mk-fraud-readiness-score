...
export function buildNarrativeStoryPlan(pack: NarrativeFactPack): NarrativeStoryPlan {
  ...
  const movements: NarrativeMovement[] = essential
    ? sustainment ? [
      ...
      { id: 'exposure', order: 4, title: 'Where deterioration could emerge', objective: 'Identify only supported change or drift watchpoints; do not fabricate fraud scenarios.', sectionIds: ['DETERIORATION-WATCHPOINTS'], transitionPurpose: 'Use supported watchpoints to define early management attention.', requiredManagementTakeaway: 'Change-triggered deterioration is caught through the normal review route, not through a new process.' },
      ...
      { id: 'conclusion', order: 6, title: 'Management conclusion', objective: 'Conclude with the value of preserving readiness and detecting early drift.', sectionIds: ['CONCLUSION'], transitionPurpose: 'End with a clear sustainment commitment.', requiredManagementTakeaway: 'The strong standard holds only while it is refreshed after material change.' }
    ] : [
      { id: 'diagnosis', order: 1, title: 'Executive diagnosis', objective: 'Explain where the organisation stands and what the result means.', sectionIds: ['EXECUTIVE-DIAGNOSIS', 'READINESS-PROFILE'], transitionPurpose: 'Show why the score requires a closer look at the few patterns driving it.', requiredManagementTakeaway: 'The result, its uncertainty and the immediate priority must be clear from this section alone.' },
      { id: 'drivers', order: 2, title: 'What is driving the result', objective: 'Synthesise the finding clusters into management themes.', sectionIds: ['SYSTEMIC-THEMES'], transitionPurpose: 'Move from broad pattern to the findings that matter most.', requiredManagementTakeaway: 'Leadership should focus on the small number of patterns with the greatest fraud-risk consequence.' },
      ...
      { id: 'response', order: 5, title: 'What management should do first', objective: 'Set first-priority controls and a readable 30/60/90 response.', sectionIds: ['MANAGEMENT-PRIORITIES', 'RESPONSE-30-60-90'], transitionPurpose: 'Close by defining what success should look like after the first response period.', requiredManagementTakeaway: 'The first controls, their owners, the timing and the success measures must all be stated.' },
    ...
    : sustainment ? [
      ...
      { id: 'exposure', order: 5, title: 'Emerging or deterioration watchpoints', objective: 'Describe only supported conditions that could erode the assessed position after change.', sectionIds: ['DETERIORATION-WATCHPOINTS'], transitionPurpose: 'Use the watchpoints to define the resilient control environment.', requiredManagementTakeaway: 'Early deterioration should be visible through management information and change-triggered review.' },
      ...
      { id: 'themes', order: 3, title: 'Systemic themes', objective: 'Explain the cross-cutting patterns and interactions the analysis identified.', sectionIds: ['SYSTEMIC-THEMES'], transitionPurpose: 'Move from patterns to the material findings supporting them.', requiredManagementTakeaway: 'The material story is created by linked conditions, not isolated question scores.' },

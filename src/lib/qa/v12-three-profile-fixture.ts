...
export const THREE_PROFILE_ENGINE_SOURCE_SHA = '85fd2a0e21a6221bbd6b5032cc0bd271ebe7d26d' as const;
export const THREE_PROFILE_V12_METHODOLOGY = 'MFRS-V1.2-CANDIDATE-OWNER-CORRECTION' as const;
export const THREE_PROFILE_V12_GRAPH = 'MFRS-V1.2-ADAPTIVE-CANDIDATE-20260821' as const;
export const THREE_PROFILE_GENERATED_AT = '2026-08-23T12:00:00.000Z' as const;
...
export function buildV12ProfileAssembled(profileKey: V12ProfileKey) {
  ...
  const data: AssembledReportData = {
    ...
    orderVerifiedAt: THREE_PROFILE_GENERATED_AT,
    ...
    generatedAt: THREE_PROFILE_GENERATED_AT,
    ...
    scoreRun: {
      ...
      status: 'completed',
      lockedAt: THREE_PROFILE_GENERATED_AT,

...
const SCENARIOS = {
  success: {
    orderReference: 'MKORD-UAT-AI2-SUCCESS',
    fulfilmentId: 'aa4a2d58-4bb2-4535-9cba-d472ae452a81',
    expectedMode: 'ai'
  },
  repair: {
    orderReference: 'MKORD-UAT-AI2-REPAIR',
    fulfilmentId: 'a8e5ede1-6c5b-4045-821a-43714bd9ff4c',
    expectedMode: 'ai_repair'
  },
  fallback: {
    orderReference: 'MKORD-UAT-AI2-FALLBACK',
    fulfilmentId: 'af3bd626-32ed-457e-a01c-09a1615d3d42',

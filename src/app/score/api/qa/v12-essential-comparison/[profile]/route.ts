...
const profiles = {
  bokamoso: {
    ...
    gateways: {
      G01: 'other_mixed', G02: 'employees_50_249', G03: 'yes', G04: 'organisation', G05: 'dedicated_internal',
      G06: 'yes', G07: 'no', G08: 'organisation', G09: 'own', G10: 'yes', G11: 'yes', G12: 'yes',
      G13: 'yes', G14: 'yes', G15: 'no', G16: 'one_person', G17: 'unknown'
    },
    values: {
  ...
  siyakhula: {
    ...
    gateways: {
      G01: 'public_nonprofit_member', G02: 'employees_10_49', G03: 'yes', G04: 'external_provider', G05: 'dedicated_internal',
      G06: 'yes', G07: 'yes', G08: 'organisation', G09: 'none', G10: 'no', G11: 'yes', G12: 'no',
      G13: 'yes', G14: 'yes', G15: 'yes', G16: 'two_or_more', G17: 'unknown'
    },
    values: {
  ...
  vhutshilo: {
    ...
    gateways: {
      G01: 'manufacturing_production', G02: 'employees_50_249', G03: 'yes', G04: 'external_provider', G05: 'dedicated_internal',
      G06: 'yes', G07: 'yes', G08: 'organisation', G09: 'none', G10: 'no', G11: 'no', G12: 'no',
      G13: 'yes', G14: 'yes', G15: 'no', G16: 'two_or_more', G17: 'unknown'
    },
    values: {
...
function valueFor(profile: Profile, nodeId: string, replacementFor: string | null, domainCode: string | null): number {
  const directOversight = (profile.oversight as Record<string, number>)[nodeId];
  if (Number.isInteger(directOversight)) return directOversight;
...
function assembledFor(profileKey: ProfileKey) {
  ...
  if (score.summary.overallScore === null || !score.summary.calculatedMaturity || !score.summary.finalMaturity) {
    throw new Error(`${profileKey}: V1.2 score was unavailable`);
  }
  ...
  const data: AssembledReportData = {
    orderId: `11111111-1111-4111-8111-${seed}`,
    orderReference: profile.orderReference,
    orderAssessmentId: `22222222-2222-4222-8222-${seed}`,
    assessmentId: `22222222-2222-4222-8222-${seed}`,
    organisationId: `33333333-3333-4333-8333-${seed}`,
    currentScoreRunId: `44444444-4444-4444-8444-${seed}`,
    ...
    productActive: true,
    scoreRun: {
      id: `44444444-4444-4444-8444-${seed}`,
      assessmentId: `22222222-2222-4222-8222-${seed}`,
...
export async function GET(request: Request, props: { params: Promise<{ profile: string }> }) {
  ...
  try {
    ...
    const composed = await composeEssentialManuscript({
      factPack: buildEssentialNarrativeFactPack(data, reportEvidenceModel, projection),
      writer: createV11WholeManuscriptWriter(MODEL, { allowTailRecovery: false })
    });
    ...
    console.error('v12_essential_comparison_failed', { profile: profileKey, message });
    return NextResponse.json({ ok: false, profile: profileKey, error: message.slice(0, 500) }, { status: 500, headers: { 'Cache-Control': 'no-store' } });
  }
}

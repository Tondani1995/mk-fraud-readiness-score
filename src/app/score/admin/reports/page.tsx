  ...
  return (
    <AdminShell admin={admin}>
      <div className="space-y-6">
        <PageHeader eyebrow="Report control" title="Generated report versions" description="Review generated report versions and access controlled admin downloads across the MK report catalogue." />
        ...
        <Card><CardHeader><CardTitle>Recent reports</CardTitle></CardHeader><CardContent className="space-y-3">
          ...
          {!reports.length ? <p className="text-sm leading-6 text-mk-muted">No generated reports yet. Reports are prepared by an authorised MK administrator from the relevant completed assessment or order.</p> : null}
        </CardContent></Card>
      </div>
    </AdminShell>
  );

                      ...
                      return (
                        <tr key={assessment.assessment_reference}>
                          <td className="py-3 font-semibold text-mk-ink">
                            <Link className="underline decoration-mk-brass/50 underline-offset-4 hover:text-mk-brassDark" href={`/score/admin/assessments/${assessment.assessment_reference}`}>

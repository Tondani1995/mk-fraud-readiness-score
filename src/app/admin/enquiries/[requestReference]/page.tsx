    ...
    <AdminShell admin={admin}>
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap gap-3">
          <Button asChild variant="secondary"><Link href="/admin/enquiries">Back to enquiries</Link></Button>
          {enquiry.assessments?.assessment_reference ? <Button asChild variant="secondary"><Link href={`/admin/assessments/${enquiry.assessments.assessment_reference}`}>Open assessment</Link></Button> : null}
        </div>
      </div>
    </AdminShell>
  );

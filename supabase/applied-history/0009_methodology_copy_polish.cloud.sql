-- AUDIT HISTORY — exact SQL applied in Production under ledger version 0009.
-- Cloud statement fingerprint (SHA-256 over statements[] joined with one blank line): da96ec9ed58f11f66f84809ad09f1044477b47f49dc11fa3147cf4e48f15856a.
-- This file is preserved for audit/reconciliation only and is not executed by migration tooling.
-- The executable SQL below is the exact cloud-applied statements[] body; only a normal trailing newline is present.
